...
<?php 
$st='in process';
$query=mysqli_query($con,"select tblcomplaints.*,user.fullname as name from tblcomplaints join user on user.id=tblcomplaints.userId where tblcomplaints.status='$st' ORDER BY regDate ASC");
